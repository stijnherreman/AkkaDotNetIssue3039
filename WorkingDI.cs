...
{
    public class WorkingDI : TestKit
    {
        public WorkingDI(ITestOutputHelper output) : base(output: output)
        {
            var containerBuilder = new ContainerBuilder();
            containerBuilder.RegisterType<BarActorStub>().As<BarActor>().SingleInstance();
